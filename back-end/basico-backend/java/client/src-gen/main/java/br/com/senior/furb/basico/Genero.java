...
public class Genero {
    ...
    public static class PagedResults {
        ...
        public List<Genero> contents;
        
        public PagedResults() {
        }
        
        public PagedResults(List<Genero> contents) {
            this.contents = contents;
        }
        
        public PagedResults(List<Genero> contents, Long totalPages, Long totalElements) {
            this.contents = contents;
     ...
     */
    public Genero(String id, String nome, String descricao, Filme filme) {
        this.id = id;
        this.nome = nome;
