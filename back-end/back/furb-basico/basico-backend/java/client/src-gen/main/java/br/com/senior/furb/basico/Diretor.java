...
public class Diretor {
     ...
     */
    public Diretor(String id, String nome, Long dataNasc, String descricao, java.util.List<Filme> filmes) {
        this.id = id;
        this.nome = nome;
     ...
     */
    public Diretor(String nome, Long dataNasc, String descricao) {
        this.nome = nome;
        this.dataNasc = dataNasc;
        this.descricao = descricao;
    }
