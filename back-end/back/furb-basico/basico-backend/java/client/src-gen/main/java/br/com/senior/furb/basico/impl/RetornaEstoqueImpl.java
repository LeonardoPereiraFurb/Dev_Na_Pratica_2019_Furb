 ...
 * 
 */
public class RetornaEstoqueImpl {
	...
	public RetornaEstoqueImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(RetornaEstoqueInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.RETORNA_ESTOQUE, //
	...
	*/
	public RetornaEstoqueOutput retornaEstoque(RetornaEstoqueInput input, long timeout) {
		...
		RetornaEstoqueOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), RetornaEstoqueOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<RetornaEstoqueOutput> retornaEstoqueRequest(RetornaEstoqueInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, RetornaEstoqueOutput.class);
	}
